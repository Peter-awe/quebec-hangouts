  ...
  activities: {
    ...
    'acropole': {
      ...
      facts: [
        ...
        ['出发时间', '9 月 1 日起，必须在日出到中午之间出发。所有人必须在日落前 3 小时离开山顶。'],
      ...
      sources: ['Sépaq · 高峡谷公园徒步路线', 'Sépaq · 高峡谷公园交通和开放时间', 'Sépaq · 国家公园门票价格']
    },
    'sbl': {
      name: '劳伦琴生物站（SBL）',
      ...
      facts: [
        ...
        ['交通', '592 chemin du lac Croche, Saint-Hippolyte。这条路上没有公交站，所以我们拼车。'],
    ...
    'redpath': {
      ...
      sources: ['Redpath · 参观（门票、开放时间）', 'Redpath · 常见问题（收藏、交通、规定）']
    },
    'mbam': {
      name: '蒙特利尔美术馆',
    ...
    'gardens-of-light': {
      ...
      facts: [
        ['晚间开放', '9 月 18 日–10 月 3 日：19:00–21:00 · 10 月 4–20 日：18:30–21:00 · 10 月 21 日–11 月 1 日：18:00–21:00'],
